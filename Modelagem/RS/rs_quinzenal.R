...
# Carrega os dados
file_path <- 'C:/Users/HP/Desktop/Projeto/Data/PreparedData/RJ/Quinzenal/RS_CONSTRUCAO_CIVIL.csv'  
...
file_path <- 'C:/Users/HP/Desktop/Projeto/Data/PreparedData/RJ/Quinzenal/RS_FERRAGENS.csv'  
fi <- read.csv(file_path)
fi$Proj_Date <- as.Date(fi$Proj_Date)
head(fi)
first_date <- min(fi$Proj_Date)  
...
file_path <- 'C:/Users/HP/Desktop/Projeto/Data/PreparedData/RJ/Quinzenal/RS_MATERIAIS_ELETRICOS.csv'  
fi <- read.csv(file_path)
fi$Proj_Date <- as.Date(fi$Proj_Date)
head(fi)
first_date <- min(fi$Proj_Date)  
